package ru.sfu.nivanova.lab6.configuration;
...
@Configuration
@ComponentScan("ru.sfu.nivanova.lab6")
@PropertySource("classpath:application.properties")
@EnableJpaRepositories("ru.sfu.nivanova.lab6.repository")
...
public class RootConfiguration {
    ...
    public EntityManagerFactory entityManagerFactory(DataSource dataSource, Properties jpaProperties) {
        ...
        factory.setPackagesToScan("ru.sfu.nivanova.lab6");
