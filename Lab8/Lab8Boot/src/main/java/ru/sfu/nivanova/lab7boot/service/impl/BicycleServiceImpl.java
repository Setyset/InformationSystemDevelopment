...
import ru.sfu.nivanova.lab7boot.msg_producer.MessageProducerService;
...
public class BicycleServiceImpl implements BicycleService {
    ...
    public Integer add(Bicycle bicycle) {
        ...
        messageProducerService.sendMessage("New bicycle\n" + bicycle, "audit");
    ...
    public boolean delete(Integer id) {
        ...
        messageProducerService.sendMessage("Deleted bicycle\n" + id, "audit");
        return true;
    }
    ...
    public Bicycle patch(Integer id, EditBicycleDTO dto) {
        ...
        messageProducerService.sendMessage("Patched bicycle\n" + bicycle, "audit");
        return bicycle;
    }
